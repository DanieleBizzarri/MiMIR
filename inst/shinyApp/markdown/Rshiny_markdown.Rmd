...
plot_na_heatmap(t(metabo_measures[,metabolites_subsets$MET57]))
```

### Correlation of the metabolites 
```{r corr metabolites, echo=FALSE}
  res<-cor_assoc(metabo_measures,metabo_measures, metabolites_subsets$MET57,metabolites_subsets$MET57)
...
multi_hist(metabo_measures[,metabolites_subsets$MET57])
```
...
a<-QCprep(as.matrix(metabo_measures[,metabolites_subsets$MET63]),
...
b<- QCprep_surrogates(as.matrix(metabo_measures[,metabolites_subsets$MET63]),
