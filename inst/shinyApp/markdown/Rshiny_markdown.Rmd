...
plot_na_heatmap(t(metabo_measures[,MET57]))
```

### Correlation of the metabolites 
```{r corr metabolites, echo=FALSE}
  res<-cor_assoc(metabo_measures,metabo_measures, MET57,MET57)
...
multi_hist(metabo_measures[,MET57])
```
...
b<- QCprep_surrogates(as.matrix(metabo_measures[,MET63]),
